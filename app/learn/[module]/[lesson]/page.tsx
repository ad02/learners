          ...
          if (hasExercise) {
            return (
              <div className="flex h-[calc(100vh-48px)]">
                ...
                <div className="flex-1 border-l border-border overflow-y-auto bg-bg-surface px-8 py-8">
                  <div className="text-sm uppercase text-accent-blue mb-4 tracking-wider font-bold">
                    Practice Exercise
                  </div>
                  {exerciseComponent}
                </div>
